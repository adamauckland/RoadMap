...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.hours_estimated'
        db.add_column('ledger_item', 'hours_estimated', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Item.hours_total'
        db.add_column('ledger_item', 'hours_total', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.hours_estimated'
        db.delete_column('ledger_item', 'hours_estimated')

        # Deleting field 'Item.hours_total'
        db.delete_column('ledger_item', 'hours_total')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 1, 8, 56, 27, 314564)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 1, 8, 56, 27, 312052)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 1, 8, 56, 27, 305737)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 1, 8, 56, 27, 304089)'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            'fixed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hours_estimated': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'hours_total': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
