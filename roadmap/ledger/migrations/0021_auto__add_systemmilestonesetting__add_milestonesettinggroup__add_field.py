...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SystemProjectSetting'
        db.create_table('ledger_systemprojectsetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project_setting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.ProjectSetting'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('ledger', ['SystemProjectSetting'])

        # Adding model 'ProjectSettingGroup'
        db.create_table('ledger_projectsettinggroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('user_setting', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('ledger', ['ProjectSettingGroup'])

        # Adding field 'ProjectSetting.group'
        db.add_column('ledger_projectsetting', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.ProjectSettingGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SystemProjectSetting'
        db.delete_table('ledger_systemprojectsetting')

        # Deleting model 'ProjectSettingGroup'
        db.delete_table('ledger_projectsettinggroup')

        # Deleting field 'ProjectSetting.group'
        db.delete_column('ledger_projectsetting', 'group_id')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 34, 19, 18253)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 34, 19, 15837)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 34, 19, 7955)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 34, 19, 540)'}),
