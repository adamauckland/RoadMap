...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ledger_target', (
            ...
            ('public', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('ledger', ['Target'])

        # Adding M2M table for field targets on 'Item'
        db.create_table('ledger_item_targets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm['ledger.item'], null=False)),
            ('target', models.ForeignKey(orm['ledger.target'], null=False))
        ))
        db.create_unique('ledger_item_targets', ['item_id', 'target_id'])


    def backwards(self, orm):
        
        # Deleting model 'Target'
        db.delete_table('ledger_target')

        # Removing M2M table for field targets on 'Item'
        db.delete_table('ledger_item_targets')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 8, 16, 43, 523930)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 8, 16, 43, 521278)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 8, 16, 43, 515047)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 8, 16, 43, 512675)'}),
