...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SystemProjectSetting.project'
        db.add_column('ledger_systemprojectsetting', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Project'], null=True), keep_default=False)

        # Adding field 'UserProjectSetting.project'
        db.add_column('ledger_userprojectsetting', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Project'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SystemProjectSetting.project'
        db.delete_column('ledger_systemprojectsetting', 'project_id')

        # Deleting field 'UserProjectSetting.project'
        db.delete_column('ledger_userprojectsetting', 'project_id')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 42, 24, 511440)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 42, 24, 508232)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 42, 24, 499552)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 3, 42, 24, 494664)'}),
