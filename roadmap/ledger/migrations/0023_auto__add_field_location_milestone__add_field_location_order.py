...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ledger_location', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ledger.Project']), keep_default=False)

        # Adding field 'Location.order'
        db.add_column('ledger_location', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.project'
        db.delete_column('ledger_location', 'project_id')

        # Deleting field 'Location.order'
        db.delete_column('ledger_location', 'order')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 14, 21, 49, 42, 392964)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 14, 21, 49, 42, 390200)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 14, 21, 49, 42, 383032)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 14, 21, 49, 42, 378684)'}),
