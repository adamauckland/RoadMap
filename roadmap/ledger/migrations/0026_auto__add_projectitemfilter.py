...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectItemFilter'
        db.create_table('ledger_projectitemfilter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('search_id', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('ledger', ['ProjectItemFilter'])

        # Adding M2M table for field project_filters on 'Project'
        db.create_table('ledger_project_project_filters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['ledger.project'], null=False)),
            ('projectitemfilter', models.ForeignKey(orm['ledger.projectitemfilter'], null=False))
        ))
        db.create_unique('ledger_project_project_filters', ['project_id', 'projectitemfilter_id'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectItemFilter'
        db.delete_table('ledger_projectitemfilter')

        # Removing M2M table for field project_filters on 'Project'
        db.delete_table('ledger_project_project_filters')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 9, 40, 17, 589947)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 9, 40, 17, 587260)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 9, 40, 17, 580261)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 9, 40, 17, 575608)'}),
        ...
        'ledger.project': {
            ...
            'project_filters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['ledger.ProjectItemFilter']", 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'})
        },
        'ledger.projectitemfilter': {
            'Meta': {'object_name': 'ProjectItemFilter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'search_id': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
