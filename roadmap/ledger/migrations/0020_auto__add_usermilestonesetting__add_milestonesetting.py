...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserProjectSetting'
        db.create_table('ledger_userprojectsetting', (
        ...
        db.send_create_signal('ledger', ['UserProjectSetting'])

        # Adding model 'ProjectSetting'
        db.create_table('ledger_projectsetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('const', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('ledger', ['ProjectSetting'])


    def backwards(self, orm):
        
        # Deleting model 'UserProjectSetting'
        db.delete_table('ledger_userprojectsetting')

        # Deleting model 'ProjectSetting'
        db.delete_table('ledger_projectsetting')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 12, 0, 15, 8, 520825)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 12, 0, 15, 8, 516291)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 12, 0, 15, 8, 508596)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 12, 0, 15, 8, 504202)'}),
