...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.follow_up'
        db.add_column('ledger_item', 'follow_up', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Target.deadline'
        db.alter_column('ledger_target', 'deadline', self.gf('django.db.models.fields.DateField')(default=False))


    def backwards(self, orm):
        
        # Deleting field 'Item.follow_up'
        db.delete_column('ledger_item', 'follow_up')

        # Changing field 'Target.deadline'
        db.alter_column('ledger_target', 'deadline', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 12, 14, 17, 15, 801956)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 12, 14, 17, 15, 799113)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 12, 14, 17, 15, 792437)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 12, 14, 17, 15, 789835)'}),
