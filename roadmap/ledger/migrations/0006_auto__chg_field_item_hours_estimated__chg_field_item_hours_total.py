...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.hours_estimated'
        db.alter_column('ledger_item', 'hours_estimated', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))

        # Changing field 'Item.hours_total'
        db.alter_column('ledger_item', 'hours_total', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1))


    def backwards(self, orm):
        
        # Changing field 'Item.hours_estimated'
        db.alter_column('ledger_item', 'hours_estimated', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Item.hours_total'
        db.alter_column('ledger_item', 'hours_total', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 2, 8, 57, 20, 883003)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 2, 8, 57, 20, 880432)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 2, 8, 57, 20, 874074)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 2, 8, 57, 20, 872320)'}),
