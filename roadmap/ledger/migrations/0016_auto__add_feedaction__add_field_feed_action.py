...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ledger_feedaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal('ledger', ['FeedAction'])

        # Adding field 'Feed.action'
        db.add_column('ledger_feed', 'action', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.FeedAction'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'FeedAction'
        db.delete_table('ledger_feedaction')

        # Deleting field 'Feed.action'
        db.delete_column('ledger_feed', 'action_id')
    ...
    models = {
        ...
        'ledger.assigned': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 21, 6, 39, 34, 361825)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ledger.comment': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 21, 6, 39, 34, 358648)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ledger.Item']"}),
        ...
        'ledger.feed': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 21, 6, 39, 34, 351453)'}),
        ...
        'ledger.item': {
            ...
            'date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 21, 6, 39, 34, 348345)'}),
